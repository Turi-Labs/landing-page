...
export function ResearchCard({ image, title, description, category, link }: ResearchCardProps) {
  return (
    <a 
  href={link} 
  className="block bg-gray-800 rounded-xl overflow-hidden group hover:shadow-xl transition-all duration-300 hover:scale-105 hover:shadow-blue-500/20"
>
  ...
  <div className="p-4 sm:p-6">
    ...
    <span className="text-blue-400 hover:text-blue-500 flex items-center gap-2 text-sm sm:text-base group-hover:gap-3 transition-all duration-300">
    Learn more 
